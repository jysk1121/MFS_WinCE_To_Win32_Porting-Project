...
//#define MAX_CASSETTE	6	// 2021.03.02 LEH - Eagle_Common_Define.h로 위치 이동
...
// Mix 결과로 255가 넘어갈 수 있는 경우가 발생함.
typedef struct _cdm_mix_result
{
	int nCount[MAX_CASSETTE];
} CDMMIXRESULT, *LPCDMMIXRESULT;
