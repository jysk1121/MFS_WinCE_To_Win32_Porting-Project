#ifndef __NH_LINE_MODEM_H__
#define __NH_LINE_MODEM_H__
...
class CLineModem : public CLineCtrl, public CNHCtrlThread
{
public:
	CLineModem();
	~CLineModem();
...
private:
	...
	CNHEvent		m_eStartCheckSerial;	// Start signal for Check Serial Thread.
	...
	CNHEvent		m_eStartCheckLine;		// Start signal for Check Line Thread.
