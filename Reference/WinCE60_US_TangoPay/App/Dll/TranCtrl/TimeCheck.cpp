...
/*-------------------------------------------------------------------
 Class    Name: CTimeCheck
 FUNCTION NAME: GetSecondsRemaining()
 RETURN TYPE  : double
 DESCRIPTION  : Returns the number of seconds remaining in the period
-------------------------------------------------------------------*/
double CTimeCheck::GetSecondsRemaining()
{
	return (this->m_TargetTime - this->m_CurTime).GetTotalSeconds();
}
