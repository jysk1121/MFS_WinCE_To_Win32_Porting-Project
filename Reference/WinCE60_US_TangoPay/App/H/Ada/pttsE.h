...
// EN_GB
#define PTTS_SPKID_JULIE	0	// Jules. 2014.10.22. separk.
// PT_BR
...
int PTTS_PlayTTS(char *TextBuf, char *tagString, int Language, int Speaker, int (*CallBack)(short nStatus));	// for HTS. 2012.08.27. separk.
int PTTS_StopTTS(void);
int PTTS_PauseTTS(void);
int PTTS_RestartTTS(void);
#endif
