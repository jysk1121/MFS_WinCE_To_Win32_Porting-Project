================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : FlashViewer Project Overview
===============================================================================

The application wizard has created this FlashViewer application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your FlashViewer application.
...
FlashViewer.h
    ...
    project specific headers and declares the CFlashViewerApp application class.

FlashViewer.cpp
    This is the main application source file that contains the application
    class CFlashViewerApp.
...
FlashViewerDlg.h, FlashViewerDlg.cpp - the dialog
    These files contain your CFlashViewerDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named FlashViewer.pch and a precompiled types file named StdAfx.obj.
