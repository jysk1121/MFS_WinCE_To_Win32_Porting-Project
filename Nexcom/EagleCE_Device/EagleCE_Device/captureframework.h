...
#define STILL_IMAGE_STATICFILE_NAME TEXT("test.jpg")
#define STILL_IMAGE_FILE_NAME TEXT("test%d.jpg")
#define VIDEO_CAPTURE_STATICFILE_NAME TEXT("test.asf")
#define VIDEO_CAPTURE_FILE_NAME TEXT("test%d.asf")
...
//#define MEDIAEVENT_TIMEOUT 10*1000
#define MEDIAEVENT_TIMEOUT 5*1000	// Time 조절 10sec -> 5sec (SKKim)
...
typedef class CCaptureFramework
{
    public:
        ...
        HRESULT SetFocusGrid();
		HRESULT RemoveFocusGrid();
        ...
        //added
		//HRESULT SetSensorProperties(const,const,const);
		...
		BOOL IsExistCameraDriver();	// V1.0.2.4 2018.07.27 - 카메라 드라이버 유무
    ...
    private:
        ...
        INT16  m_lPictureNumber;
        INT16 m_lCaptureNumber;
        ...
        CComPtr<IDirectDrawGammaControl> m_pGammaControl;
