...
/** \addtogroup Attributes */ //@{
	...
	static DWORD GetTypeIdFromName(const char* ext);
...
/** \addtogroup Decode */ //@{
	...
	// Pinned to char*: cximage.lib exports ?Load@CxImage@@QAE_NPBDK@Z (ANSI).
...
#endif
	// For UNICODE support: char -> TCHAR
	// Pinned to char*: cximage.lib exports ?Save@CxImage@@QAE_NPBDK@Z (ANSI).
	bool Save(const char* filename, DWORD imagetype);
