#ifndef __NH_SCREEN_DISPLAY_H__
#define __NH_SCREEN_DISPLAY_H__
...
void	DisplayMouseEvent(POINT &pos, CNScreen *pCurScreen);					// [2ND] NH AIREAT 2008.11.12
...
public:
	...
	CScrMsg(const CScrMsg &Msg)
	{
		...
		m_Point = Msg.m_Point;				// [2ND] NH AIREAT 2008.11.12
	};
	...
	CScrMsg& operator= (const CScrMsg &Msg)
	{
		...
		this->m_Point = Msg.m_Point;		// [2ND] NH AIREAT 2008.11.12
...
public:
	CString		m_strCmd;
	CString		m_strData;
	POINT		m_Point;					// [2ND] NH AIREAT 2008.11.12
};
...
extern SIZE			g_BaseSizeScreen;		// 기준 Screen Resolution (Width, Height)
