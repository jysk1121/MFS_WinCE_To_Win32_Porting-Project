...
#include "sqlite3.h"
#else
// Win32 compiles the SQLite amalgamation into this DLL; the sqlite3.h
// sitting next to this header belongs to the WinCE wceSQLite3 build.
#include "sqlite_win32/sqlite3.h"
#endif	// _WIN32_WCE
#include <vector>
