...
public:
	...
	HANDLE	m_hStatusThread;			// Status 감시 스레드 핸들
	CQueue m_QueueRead;

	CRITICAL_SECTION m_cs;
//	static CEPPComm* m_pInstance;
//	static void CreateInstance();
//	static void ReleaseInstance();
//	static CEPPComm* GetInstance();
...
//	int OpenDevice(int nPortNum, DWORD dwBaud, BYTE byPollFlag);
...
//	void SetCallBackFunc(int (*func)(int, int));
//	int CallFunc(int i, int k);
