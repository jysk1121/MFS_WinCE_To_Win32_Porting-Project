#ifndef __NH_PTR_LINKED_LIST_H__
#define __NH_PTR_LINKED_LIST_H__
...
public:
	...
	CNHPtrLinkedList& operator= (const CNHPtrLinkedList &ErrDesc);
...
#include ".\NHPtrLinkedList.hpp"

#endif //__NH_PTR_LINKED_LIST_H__